...
function Install_Detect()
{
    ...
    {
        document.write('<div style="width: 100%; text-align: center; vertical-align: middle; line-height: 20pt; padding-bottom: 12px; padding-top: 12px;">');
        document.write('<strong> 检测到报表插件未安装，请安装报表插件！<br /></strong>');
